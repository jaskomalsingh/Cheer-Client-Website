    ...
    return (
        <div className="mini-side-bar">
            <div className="overlap-group-2">
                ...
                <Link to="../cm3">
                    <div className="text-wrapper-17 " style={activeTab==="Subscribers" ?  {"text-decoration": "underline", "text-decoration-thickness": "20%"}: {}} onClick={() => onClick("Subscribers")}>Subscribers</div>
                </Link>
                <Link to="../cm2">
                    <div className="text-wrapper-18">Newsletters</div>
                </Link>
                <Link to="../cm1">
